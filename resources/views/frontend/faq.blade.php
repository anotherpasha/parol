            ...
            <div class="panel-heading active" role="tab">
              <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#1" aria-expanded="true" aria-controls="collapseOne">
                  Apa yang harus saya lakukan apabila saya mau melakukan klaim?
                </a>
            ...
            <div class="panel-heading" role="tab" id="headingTwo">
              <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#2" aria-expanded="false" aria-controls="collapseTwo">
                    Dalam waktu berapa lama saya bisa dapat kepastian klaim?
                </a>
                <span class="icon-panel"></span>
              </h4>
            </div>
            ...
            <div class="panel-heading" role="tab">
              <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#3" aria-expanded="false" aria-controls="collapseThree">
                  Apa saja yang harus disiapkan untuk melakukan klaim?
                </a>
                <span class="icon-panel"></span>
              </h4>
            </div>
            ...
            <div class="panel-heading" role="tab">
              <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#4" aria-expanded="false" aria-controls="collapseThree">
                  Apakah agen yang bisa ditemui secara langsung?
                </a>
                <span class="icon-panel"></span>
              </h4>
            </div>
            ...
            <div class="panel-heading" role="tab">
              <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#5" aria-expanded="false" aria-controls="collapseThree">
                  Apakah bencana termasuk dalam perlindungan?
                </a>
                <span class="icon-panel"></span>
              </h4>
            </div>
