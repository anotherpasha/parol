...
@section('content')
    ...
    <form class="repeater" action="{{ action('SlidersController@store') }}" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-2-3">
                <div class="uk-margin">
                    <input class="uk-input uk-form-medium uk-width-1-1" type="text" name="gallery_name" placeholder="Slider Name.." autofocus>
                </div>
                ...
                <hr>
                <button data-repeater-create type="button" class="uk-button uk-button-small uk-button-danger uk-align-right"  title="Add More" uk-tooltip><span class="fa fa-plus uk-margin-small-right"></span>ADD MORE</button>
            </div>
...
@section('page-level-scripts')
    ...
    <script src="{!! asset('assets/js/lib/jquery.repeater.min.js') !!}"></script>
