...
@section('content')
    <h3>
        ...
        @can('posts.add')
            <a href="{!! action('SlidersController@create') !!}" class="uk-button uk-button-primary uk-button-small uk-margin-left">Add New</a>
        @endif
    </h3>
...
<script type="text/javascript">
    $(function() {
        $('#thetable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! action('SlidersController@datatableList') !!}',
            columns: [
