...
@section('content')
    ...
    <form class="uk-form" action="{!! action('PostsController@update', $post->id) !!}" method="POST">
        {!! csrf_field() !!}
            ...
            <div class="uk-width-1-3">
                <div class="uk-card uk-card-small uk-card-body uk-margin uk-margin-top k-border white">
                    <div class="uk-margin">
                        ...
                        <input type="text" class="uk-input uk-form-medium" name="publish_date" data-uk-datepicker="{format:'DD/MM/YYYY',maxDate:0}"
                        @if(old('publish_date') != '')
