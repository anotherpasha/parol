...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_wysiwyg__ = __webpack_require__(295);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_wysiwyg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue_wysiwyg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_KeypairSection__ = __webpack_require__(296);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_KeypairSection___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_KeypairSection__);
...
Vue.use(__WEBPACK_IMPORTED_MODULE_0_vue_wysiwyg___default.a, { hideModules: { "image": true } });

var app = new Vue({
    el: '#product',

    components: {
        keypairsection: __WEBPACK_IMPORTED_MODULE_1__components_KeypairSection___default.a
        //FormListMode3
    },
    ...
    methods: {
        addSection: function addSection(type, lang) {
            var section = {
                type: type,
                title: '',
                description: '',
        ...
        removeSection: function removeSection(index, lang) {
        ...
        removeKeypair: function removeKeypair(index, lang, kIndex) {
            if (this.sectionList[lang][index]['keypairList'].length > 0) {
                this.sectionList[lang][index]['keypairList'].splice(kIndex, 1);
            }
        },
        parseExistingSections: function parseExistingSections(sections) {
            var vm = this;
            sections.forEach(function (sec) {
                if (sec.type == 'plain') {
                    ...
                    var parsedContent = JSON.parse(sec.content);
                    var keypairList = [];
...
var disposed = false
var normalizeComponent = __webpack_require__(297)
/* script */
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        addKeypair: function addKeypair() {
            var keypair = {
                key: '',
                value: ''
            };
        ...
        removeKeypair: function removeKeypair(index) {
    ...
    [
      _c(
        "button",
        {
          ...
          attrs: { type: "button" },
          on: { click: _vm.addKeypair }
        },
        [_vm._v("Add")]
      ),
      _vm._v(" "),
      _vm._l(_vm.keypairList, function(keypair, index) {
        return _c("div", [
          _c("a", {
            attrs: { "uk-close": "" },
            on: {
              click: function($event) {
                _vm.removeKeypair(index)
              }
            }
          }),
          _vm._v(" "),
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.keypairList[index].key,
                  expression: "keypairList[index].key"
                }
              ],
              staticClass: "uk-input",
              attrs: { type: "text", name: "keypair[]" },
              domProps: { value: _vm.keypairList[index].key },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.keypairList[index], "key", $event.target.value)
                }
              }
            })
          ]),
          ...
          _c(
            ...
            [
              _c("wysiwyg", {
                model: {
                  value: _vm.keypairList[index].value,
                  callback: function($$v) {
                    _vm.$set(_vm.keypairList[index], "value", $$v)
                  },
                  expression: "keypairList[index].value"
                }
              })
            ],
            1
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(13), __webpack_require__(4)(module)))
